...
const AdminHeader = ({
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-[#071A2B] bg-[#071A2B] text-white shadow-sm lg:border-[#E5E7EB] lg:bg-white lg:text-[#152238]">
      <div className="flex min-h-[58px] items-center justify-between gap-3 px-4 sm:px-6 lg:min-h-[72px] lg:px-8">
        ...
        <div className="flex min-w-0 flex-1 items-center gap-3">
          ...
          {/* Mobile menu */}
          <h1 className="text-base font-bold lg:hidden">{mobileTitle}</h1>

          <button
            type="button"
            onClick={onToggleSidebar}
            className="order-2 grid h-8 w-8 shrink-0 place-items-center rounded-lg text-white transition-colors hover:bg-white/10 lg:hidden"
