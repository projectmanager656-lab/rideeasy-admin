      ...
      <main className="w-full max-w-[420px] rounded-[24px] border border-[#1D3042] bg-[#06111D] px-6 py-8 shadow-[0_24px_70px_rgba(0,0,0,0.42)] sm:px-9 sm:py-10">
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#FFA726] px-4 text-base font-bold text-[#06111D] shadow-[0_8px_18px_rgba(255,167,38,0.18)] transition hover:bg-[#FFB74D] active:translate-y-px active:bg-[#F59E0B] disabled:cursor-not-allowed disabled:opacity-60"
          >
            {loading && (
