...
const AdminDashboard = () => {
  ...
  return (
    ...
    >
      {/* Welcome Message */}
      <div className="mb-6 max-w-4xl rounded-xl border border-[#ffd89a] bg-[#FFF3E0] p-4 sm:p-5">
        <div className="flex items-start gap-3">
          <div className="grid h-9 w-9 shrink-0 place-items-center rounded-lg bg-[#FFA726] text-[#111827]">
            <i className="ri-shield-star-line text-lg" />
          </div>
          <div>
        <h2 className="text-lg sm:text-xl font-bold text-[#111827]">Welcome, Super Admin</h2>
        <p className="mt-1 text-sm text-[#6B7280]">
          You are signed in with an admin JWT. This console covers users, drivers, rides, payments, pricing, and safety operations.
        </p>
          </div>
        </div>
      </div>
